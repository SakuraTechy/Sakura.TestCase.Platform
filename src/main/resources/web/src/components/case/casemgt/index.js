      ...
      <div style={{ position: 'relative', minHeight: '80vh' }}>
        ...
        >
          ...
          <AgileTCEditor
            ...
            wsUrl = {window.location.protocol=='http:'?`ws://${window.location.host}/api/case/${caseId}/${itemid}/${iscore}/${user}`:`wss://172.19.5.227:18443/api/case/${caseId}/${itemid}/${iscore}/${user}`}
