      ...
      <div style={{ position: 'relative', minHeight: '80vh' }}>
        ...
        >
          ...
          <AgileTCEditor
            ...
            wsUrl = {window.location.protocol=='http:'?`ws://${window.location.host}/api/case/${caseId}/${itemid}/${iscore}/${user}`:`wss://www.sakura.hk.cn:18443/api/case/${caseId}/${itemid}/${iscore}/${user}`}
