      ...
      if (!readOnly) {
        ...
        buttons.forEach(button => {
          ...
          main.button({
            ...
            action: () => {
              if (
                'AppendSiblingNode,AppendChildNode,AppendParentNode'.indexOf(command) >
                            -1
              ) {
        ...
        case '0':
          this.minder.setStatus('readonly')
            ...
            document.removeEventListener('keydown', this.handleKeyDown)
                ...
                notification.warning({ message: '场景被锁住，当前只读' })
                break
        ...
        case '1':
          this.minder.setStatus('normal', true)
            ...
            document.addEventListener('keydown', this.handleKeyDown)
                ...
                notification.warning({ message: '场景被解锁，请刷新重试' })
          break
                          ...
                          <List.Item>
                            <List.Item.Meta
                              avatar={
                                <Avatar
                                  style={{
                                    backgroundColor: this.getColorByName(
                                      item,
                                    ),
                                  }}
                                >
